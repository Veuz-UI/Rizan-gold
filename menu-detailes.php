...
<div class="container">
    <section class="about-page">
        <h3 class="order-detailes-head">Order # 412 was placed on OCT 30, 2023 and is currently pending.</h3>
        <div class="order-list-box">
            <div class="row d-flex align-items-center">
                <div class="col-lg-8">    
                    <div class="table-responsive">
                        <table class="table mb-0 da">
                
                            <thead class="table-light order-table">
                                <tr>
                                    <th>Product</th>
                                    <th>Total</th>
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    <td scope="row" class="table-head-main-cntnt">8 Grams 22K (916) Gold Coin RJGC22K8G × 1</td>
                                    <td class="table-values">USD 518.00</td>
                                </tr>
                                <tr>
                                    <td scope="row" class="table-head-main-cntnt">Subtotal:</td>
                                    <td class="table-values">USD 518.00</td>
                                </tr>
                                <tr>
                                    <td scope="row" class="table-head-main-cntnt">Shipping Charge:</td>
                                    <td class="table-values">USD 518.00</td>
                                </tr>
                                <tr>
                                    <td scope="row" class="table-head-main-cntnt">Payment method:</td>
                                    <td class="table-values">Online Payment</td>
                                </tr>
                                <tr>
                                    <td scope="row" class="table-head-main-cntnt">Total:</td>
                                    <td class="table-values-total">USD 531.50</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
