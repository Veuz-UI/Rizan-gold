<?php include("header.php") ?>
      ...
      <section class="shop-by-cat cart-page">
                    ...
                    <table class="cart-items table" cellspacing="0">
                        ...
                        <tbody>
                            <tr class="cart-item">		
                                <td class="product-thumbnail">
                                    <a href="product-details.php">
                                        <img width="600" height="600" src="img/new1.png" class="product-image" alt="">
                                    </a>				
                                    <div class="product-name">
                                        <a href="product-details.php">Golden Chain</a>								
                                    </div>
                                </td>
                                <td class="product-price">
                                    <span class="price">AED 10,456.00</span>
                                </td>
                            ...
                            <tr class="cart-item">		
                                <td class="product-thumbnail">
                                    <a href="product-details.php">
                                        <img width="600" height="600" src="img/new2.png" class="product-image" alt="">
                                    </a>				
                                    <div class="product-name">
                                        <a href="product-details.php">Couple Rings</a>								
                                    </div>
                                </td>
                                <td class="product-price">
                                    <span>AED 12,456.00</span>
                                </td>
                                <td class="product-count">
                                    <form action="#">
                                        <div class="qtyminus">-</div>
                                ...
                                <td class="product-subtotal">
                                    <span class="price">AED 12,456.00</span>
                                </td>
                                <td class="product-remove">
                                    <a href="#" class="remove">x</a>							
                                </td>
                            ...
                            <tr>
                                <td colspan="6" class="actions">
                                    <div class="bottom-cart">
                                        ...
                                        <div class="cart-btns">
                                            <h2><a href="product.php">Continue Shopping</a></h2>
                ...
                <div class="cart-totals">
                    ...
                    <div>
                        <div class="cart-subtotal">
                            <div class="title">Cart Subtotal</div>
                            <div><span>AED 22,912.00</span></div>
                        </div>
                        <div class="cart-subtotal">
                            <div class="title">Shipping Charge</div>
                            <div><span>AED 400.00</span></div>
                        </div>
                        <div class="cart-subtotal">
                            <div class="title">Order Total</div>
                            <div class="order-total"><span>AED 23,312.00</span></div>
                        </div>
                    </div>
