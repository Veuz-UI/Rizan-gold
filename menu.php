        ...
        <div class="row">
            <div class="col-lg-3" data-aos="fade-right" data-aos-duration="1500">
                <div class="left-sidebar">
                    <div class="nav flex-column nav-tabs text-center menu-tabs" id="v-tabs-tab" role="tablist"
                    aria-orientation="vertical">
                    <div class="block-title">Menu</div>
                    <a class="nav-link active" id="v-tabs-home-tab" data-bs-toggle="tab" href="#v-tabs-home" role="tab"
                        aria-controls="v-tabs-home" aria-selected="true"><span><i class="fa-solid fa-chevron-right"></i></span>Order History</a>
                    <a class="nav-link" id="v-tabs-profile-tab" data-bs-toggle="tab" href="#v-tabs-profile" role="tab"
                        aria-controls="v-tabs-profile" aria-selected="false"><span><i class="fa-solid fa-chevron-right"></i></span>Addresses</a>
                    <a class="nav-link" id="v-tabs-messages-tab" data-bs-toggle="tab" href="#v-tabs-messages" role="tab"
                        aria-controls="v-tabs-messages" aria-selected="false"><span><i class="fa-solid fa-chevron-right"></i></span>Account details</a>
                    <a class="nav-link"><span><i class="fa-solid fa-chevron-right"></i></span>Logout</a>
                </div>
                </div>
            ...
            <div class="col-lg-9" data-aos="fade-left" data-aos-duration="1500">
                <div class="tab-content" id="v-tabs-tabContent">
                    <div class="tab-pane fade show active" id="v-tabs-home" role="tabpanel"
                        ...
                        <div class="order-list-box">
                            <div class="row d-flex align-items-center">
                                <div class="col-lg-1">
                                    <h6 class="order-list-head">Order #</h6>
                                    <h5 class="order-list-main">#412</h5>
                                </div>
                                <div class="col-lg-3">
                                    <h6 class="order-list-head">Date</h6>
                                    <h5 class="order-list-main">OCT 30, 2023</h5>
                                </div>
                                <div class="col-lg-2">
                                    <h6 class="order-list-head">Status</h6>
                                    <h5 class="order-status order-pending">pending</h5>
                                </div>
                                <div class="col-lg-3">
                                    <h6 class="order-list-head">Total</h6>
                                    <h5 class="order-list-main">USD 531.50 for 1 items</h5>
                                </div>
                                <div class="col-lg-3 d-flex justify-content-md-center">
                                    <a href="menu-detailes.php"><button type="button" class="btn1 order-btn">view more</button></a>
                                </div>
                            </div>
                        </div>
                        <div class="order-list-box">
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-lg-2">
                                    <h6 class="order-list-head">Status</h6>
                                    <h5 class="order-status order-completed">Completed</h5>
                                </div>
                                <div class="col-lg-3">
                                    <h6 class="order-list-head">Total</h6>
                                    <h5 class="order-list-main">USD 531.50 for 1 items</h5>
                        ...
                        <div class="order-list-box">
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-lg-2">
                                    <h6 class="order-list-head">Status</h6>
                                    <h5 class="order-status order-procces">In Procces</h5>
                                </div>
                                <div class="col-lg-3">
                                    <h6 class="order-list-head">Total</h6>
                                    <h5 class="order-list-main">USD 531.50 for 1 items</h5>
                        ...
                        <div class="order-list-box">
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-lg-2">
                                    <h6 class="order-list-head">Status</h6>
                                    <h5 class="order-status order-canceled">Canceled</h5>
                                </div>
                                <div class="col-lg-3">
                                    <h6 class="order-list-head">Total</h6>
                                    <h5 class="order-list-main">USD 531.50 for 1 items</h5>
                                ...
                                <div class="col-lg-3 d-flex justify-content-md-center">
                                    <a href="menu-detailes.php">
                                        <button type="button" class="btn1 order-btn">view more</button>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="v-tabs-profile" role="tabpanel" aria-labelledby="v-tabs-profile-tab">
                        <h6 class="menu-short-para">The following addresses will be used on the checkout page by default.</h6>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="adress-box">
                                    <h4>Billing address</h4>
                                    <ul class="billing-list">
                                        <li>Name:<span>Bishru Rahman</span></li>
                                        <li>City: <span>Calicut, 673014</span></li>
                                        <li>Mobile No:<span>+8129407134</span> </li>
                                        <li>State:<span>Kerala</span></li>
                                    </ul>
                                    <button type="button" class="btn1 order-btn mt-2">Edit</button>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="adress-box">
                    ...
                    <div class="tab-pane fade" id="v-tabs-messages" role="tabpanel"
                        ...
                        <div class="shipping-address">
                            <h4 class="shipping-address-head">Account Details</h4>
                           <div class="row">
                            <div class="col-md-6">
                                <input type="text" placeholder="First Name" value="arshad">
                            </div>
                            <div class="col-md-6">
                                <input type="text" placeholder="Last Name" value="P">
                            </div>
                            <div class="col-md-6">
                                <input type="email" placeholder="Email" value="itsarshu@gmail.com">
                            </div>
                            <h4 class="shipping-address-head">Password change</h4>
                            <div class="col-md-6">
                           ...
                           <div class="col-lg-12 justify-content-center">
                            <button type="button" class="btn1 order-btn input-btn">Save Changes</button>
                           </div>
                    ...
                    <div class="contact-icon">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                ...
                                fill="white" />
                            <path
                                d="M10.0001 3.47717C7.8432 3.47717 6.08875 5.23206 6.08875 7.38852C6.08875 9.54497 7.8432 11.2999 10.0001 11.2999C12.157 11.2999 13.9114 9.54497 13.9114 7.38852C13.9114 5.23206 12.157 3.47717 10.0001 3.47717ZM10.0001 10.4307C8.32299 10.4307 6.95793 9.06605 6.95793 7.38852C6.95793 5.71098 8.32299 4.34636 10.0001 4.34636C11.6772 4.34636 13.0422 5.71098 13.0422 7.38852C13.0422 9.06605 11.6772 10.4307 10.0001 10.4307Z"
                                fill="white" />
                        </svg>
                    ...
                    <div class="contact-icon">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_1_150)">
                                <path
                                    d="M10 19.5C4.76169 19.5 0.5 15.2383 0.5 10C0.5 4.76169 4.76169 0.5 10 0.5C15.2383 0.5 19.5 4.76169 19.5 10C19.5 15.2383 15.2383 19.5 10 19.5ZM10 1.40476C5.2606 1.40476 1.40476 5.2606 1.40476 10C1.40476 14.7394 5.2606 18.5952 10 18.5952C14.7394 18.5952 18.5952 14.7394 18.5952 10C18.5952 5.2606 14.7394 1.40476 10 1.40476Z"
                                    fill="white" />
                                <path
                                    d="M14.4233 10.4524H9.99999C9.75014 10.4524 9.54761 10.2498 9.54761 9.99998V3.51586C9.54761 3.26601 9.75014 3.06348 9.99999 3.06348C10.2498 3.06348 10.4524 3.26601 10.4524 3.51586V9.5476H14.4233C14.6731 9.5476 14.8756 9.75013 14.8756 9.99998C14.8756 10.2498 14.6731 10.4524 14.4233 10.4524Z"
                                    fill="white" />
                            </g>
                            <defs>
