<?php include("header.php") ?>
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <section class="shop-by-cat blog-page">
            ...
            <div class="row">
                <div class="col-md-3 left-sidebar">
                    ...
                    <div class="blog-block">
                        ...
                        <div class="block-content">
                            <ul class="blog-category">
                                <li><a href="#"><i class="fa-solid fa-chevron-right"></i>Earrings</a></li>
                                <li><a href="#"><i class="fa-solid fa-chevron-right"></i>Bangles</a></li>
                                <li><a href="#"><i class="fa-solid fa-chevron-right"></i>Necklace</a></li>
                                <li><a href="#"><i class="fa-solid fa-chevron-right"></i>Bracelets</a></li>
                                <li><a href="#"><i class="fa-solid fa-chevron-right"></i>Baby Collections</a></li>
                                <li><a href="#"><i class="fa-solid fa-chevron-right"></i>Wedding Ring</a></li>
                                <li><a href="#"><i class="fa-solid fa-chevron-right"></i>Pendant</a></li>
                                <li><a href="#"><i class="fa-solid fa-chevron-right"></i>Nose Pin</a></li>
                                <li><a href="#"><i class="fa-solid fa-chevron-right"></i>Mangalsutra</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="blog-block">
                        ...
                        <div class="block-content">
                            <a href="blog-details.php"><div class="latest-blogbox">
                                <div class="latest-blogimg">
                                    <img src="img/blog1.jpg" alt="">
                                </div>
                                <div class="latest-blogcontent">
                                    <h6>November 5, 2023</h6>
                                    <h5>How to Flaunt Your Gold Earrings This Festive Season!</h5>
                                </div>
                            </div></a>
                            <a href="blog-details.php"><div class="latest-blogbox">
                                <div class="latest-blogimg">
                                ...
                                <div class="latest-blogcontent">
                                    <h6>November 5, 2023</h6>
                                    <h5>Bridal Jewellery Set: Choose the Best One For Your Wedding</h5>
                                </div>
                            </div></a>
                            <a href="blog-details.php"><div class="latest-blogbox">
                                <div class="latest-blogimg">
                                ...
                                <div class="latest-blogcontent">
                                    <h6>November 5, 2023</h6>
                                    <h5>Gorgeous Diamond Jewellery to Celebrate Little Milestones in Your Life</h5>
                                </div>
                            </div></a>
                        </div>
                    </div>
                    <div class="blog-block">
                        ...
                        <div class="block-content">
                            <form method="get" class="newsletter-form" action="">
                                <input type="text" value="" name="s" class="s" placeholder="Your Email Address">
                                <button type="button" class="btn2" fdprocessedid="ypqniu">
                    ...
                    <div class="blog-block block-last">
                ...
                <div class="col-md-9 px-mob-0">
                   <div class="blog-grid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mainblog-box">
                                <div class="mainblog-img">
                                    <img src="img/blog2.jpg" alt="">
                                </div>
                                <div class="mainblog-content">
                                    ...
                                    <ul>
                                        <li><i class="fa-regular fa-calendar"></i>November 5, 2023</li>
                                        <li><svg width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M11 12.25V11C11 10.337 10.7366 9.70107 10.2678 9.23223C9.79893 8.76339 9.16304 8.5 8.5 8.5H3.5C2.83696 8.5 2.20107 8.76339 1.73223 9.23223C1.26339 9.70107 1 10.337 1 11V12.25" stroke="#868686" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M6 6C7.38071 6 8.5 4.88071 8.5 3.5C8.5 2.11929 7.38071 1 6 1C4.61929 1 3.5 2.11929 3.5 3.5C3.5 4.88071 4.61929 6 6 6Z" stroke="#868686" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
