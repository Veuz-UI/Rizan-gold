                ...
                <div class="col-md-7">
                       ...
                       <div class="checkbox checkbox1">
                        ...
                        <label for="form-checkbox-1">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 200 200">
                            ...
                            <rect mask="url(#checkbox-mask)" stroke-width="18" height="200" width="200"></rect>
                    ...
                    <div class="shipping-address">
                       ...
                       <div class="row">
                        ...
                        <div class="col-md-12">
                            <textarea class="form-control" cols="30" rows="3" placeholder="Notes about your order, e.g. special notes for delivery."></textarea>
                                ...
                                <div class="cart-item">
                                    <div class="info-product">
                                        <div class="product-thumbnail">
                                            <img width="600" height="600" src="img/new1.png" alt="">					
                                        </div>
                                    ...
                                    <div class="product-total">
                                        <span>AED 300.00</span>
                                    </div>
                                </div>
                                <div class="cart-item">
                                    <div class="info-product">
                                        <div class="product-thumbnail">
                                            <img width="600" height="600" src="img/new2.png" alt="">					
                                        </div>
                                        <div class="product-name">
                                            Couple Rings
